...
<head>
                ...
                <div class="col-12">
                    <div class="card" style="margin-top: 20px;">
                        <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                            <h4 class="mb-0">{{ __('edit_invoice') }}</h4>
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('invoices.update', $invoice) }}" class="theme-form">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" step="0.01" name="fee" id="fee"
                                                ...
                                                value="{{ old('fee', $invoice->fee) }}" placeholder="0.00" required
                                                autofocus>
                                            @error('fee')
                                            ...
                                            <div class="col-xxl-9 box-col-12">
                                                <div class="input-group flatpicker-calender">
                                                    <input class="form-control @error('end_date') is-invalid @enderror"
                                                        ...
                                                        value="{{ old('end_date', $invoice->end_date ? $invoice->end_date->format('Y-m-d') : '') }}"
                                                        required>
                                                    @error('end_date')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                    ...
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <select name="member_id" id="member_id"
                                                ...
                                                <option value="{{ $member->id }}"
                                                    {{ (old('member_id', $invoice->member_id) == $member->id) ? 'selected' : '' }}>
                                                    {{ $member->full_name }}
                                                </option>
                                                @endforeach
                                            </select>
                                            ...
                                            <div class="col-xxl-9 box-col-12">
                                                <div class="input-group flatpicker-calender">
                                                    <input
                                                        ...
                                                        type="date"
                                                        value="{{ old('start_date', $invoice->start_date ? $invoice->start_date->format('Y-m-d') : '') }}"
                                                        required>
                                                    @error('start_date')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                        ...
                                        <div class="col-12 text-end mt-4">
                                            <button type="submit" class="btn btn-primary px-5 py-2">
                                                <i class="fa fa-save me-2"></i> {{ __('update_invoice') }}
                                            </button>
                                        </div>
                                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Set minimum date for start_date to today (but allow editing past dates)
        ...
        // Set initial min for end_date if start_date has a value
