                ...
                <div class="col-12">
                    <div class="card" style="margin-top: 20px;">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('users.update', $user->id) }}" class="theme-form">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row g-4">
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" id="name"
                                                ...
                                                value="{{ old('name', $user->name) }}" placeholder="{{ __('name') }}" required autofocus>
                                            @error('name')
                                    ...
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12">
                                        ...
                                        <div class="mb-3">
                                            <label class="col-form-label" for="password">{{ __('password') }} (leave blank to keep current)</label>
                                        ...
                                        <div class="mb-3">
                                            <label class="col-form-label" for="password_confirmation">{{ __('confirm_password') }}</label>
