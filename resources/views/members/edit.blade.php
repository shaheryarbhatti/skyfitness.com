                                    ...
                                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="nik" id="nik"
                                                ...
                                                value="{{ old('nik', $member->nik) }}" placeholder="16-digit NIK number">
                                        </div>
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-sm-6">
                                                <label class="box-col-12 text-start">{{ __('date_of_birth') }}</label>
                                        ...
                                        <div class="row g-4 mt-2">
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                    <small class="text-muted">Leave blank to keep the existing password, or enter a new one.</small>
                                                </div>
                                            </div>
                                        </div>
                                        </div>
